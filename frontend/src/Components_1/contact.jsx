        ...
        <div className={cnt["contact-cts"]}>
            ...
            <div className={cnt["form-cts"]}>
                ...
                <form method="post" id="feedbackForm" autocomplete="on" onSubmit={handleSubmit}>
                    ...
                    <div className={cnt["flex-rev-cts"]}>
                       <input type="email" placeholder="Email" name="email" id="email" onchange="return checkEmail()" required />
                       <label for="email">Your Email</label>
                    </div>
                    <div className={cnt["flex-rev-cts"]}>
                       <textarea placeholder="Feel free to share your opinion on our website" name="response" id="message" required ></textarea>
                       <label for="message">Email Message</label>
                    </div>
                    <button className={cnt['Button-submit']} id="send-feedback" type="submit">Submit Feedback</button>
                </form>
            </div>
        </div>
    </div>
